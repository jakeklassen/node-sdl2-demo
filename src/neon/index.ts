...
import { DEG_TO_RAD } from "../lib/math.ts";
...
import { Vector2d } from "./lib/vector2d.ts";
import { MovementSystem } from "./systems/movement-system.ts";
import { RenderingSystem } from "./systems/rendering-system.ts";
import { RotationSystem } from "./systems/rotation-system.ts";
...
function generateImages(cache: Record<string, Image>) {
